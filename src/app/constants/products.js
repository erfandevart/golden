/**
 * لیست محصولات و مپینگ آن‌ها با داده‌های API
 */
...
/**
 * مپینگ ID محصولات به کلیدهای API
 */
export const PRODUCT_API_MAP = {
  YekGram18: "YekGram18",
  YekGram20: "YekGram20",
  YekGram21: "YekGram21",
  ounce_gold: "OunceTala",
  sekke_emami: "SekehEmam",
  SekehRob: "SekehRob",
  SekehNim: "SekehNim",
  SekehTamam: "SekehTamam",
  SekehGerami: "SekehGerami",
  usd: "Dollar",
  derham: "Derham",
  euro: "Euro",
};
...
/**
 * لیست ID محصولاتی که قیمت آن‌ها باید در 1000 ضرب شود
 */
export const PRODUCTS_WITH_THOUSAND_MULTIPLIER = [
  "sekke_emami",
  "SekehRob",
  "SekehNim",
  "SekehTamam",
